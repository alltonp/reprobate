...
object Messages {
  ...
  def notAuthorised(who: String) = List(customRed(s"easy ${who}, please set your initials first: ") + "'rtm aka pa'")
  ...
  def help(who: String) = List(
    s"hello ${who}, welcome to rtm - rudimentary time management © 2015-2017 spabloshi ltd",
    "",
    "issues:",
