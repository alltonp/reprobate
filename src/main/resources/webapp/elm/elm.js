...
var _alltonp$reprobate$Belch$PortMessage = F2(
	function (a, b) {
...
var _alltonp$reprobate$CommandEditor_Port$commandEditorAgentFromLift = _elm_lang$core$Native_Platform.incomingPort(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'typeName', _elm_lang$core$Json_Decode$string)));
	...
	function (v, disable) {
		return A2(
			_elm_lang$html$Html$input,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$placeholder('Command'),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _alltonp$reprobate$CommandEditor_View$onEnter(_alltonp$reprobate$CommandEditor_Msg$RunCommand),
								_1: {
									ctor: '::',
...
var _alltonp$reprobate$CommandEditor_View$agentView = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_alltonp$reprobate$CommandEditor_View$commandEditor, model.command, false),
			_1: {ctor: '[]'}
		});
};
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: _alltonp$reprobate$CommandEditor_View$agentView(model),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
	...
	return A2(
		_elm_lang$html$Html$button,
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: A2(_alltonp$reprobate$CommandEditor_View_ops['=>'], 'padding', '0px'),
						_1: {
							ctor: '::',
							_0: A2(_alltonp$reprobate$CommandEditor_View_ops['=>'], 'margin', '0px'),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_alltonp$reprobate$CommandEditor_Msg$RunCommand),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$title('Run Command'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$disabled(disable),
							_1: {ctor: '[]'}
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('fa fa-plus-circle fa-2x'),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {ctor: '[]'}
...
var _alltonp$reprobate$CommandEditorAgent$main = _elm_lang$html$Html$program(
	{init: _alltonp$reprobate$CommandEditor_Update$init, view: _alltonp$reprobate$CommandEditorAgent$view, update: _alltonp$reprobate$CommandEditorAgent$update, subscriptions: _alltonp$reprobate$CommandEditorAgent$subscriptions})();
...
var _alltonp$reprobate$ConfigEditor_Codec$agentModelDecoder = A2(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$string));
var _alltonp$reprobate$ConfigEditor_Codec$decodeAgentModel = function (serialised) {
	return A2(_elm_lang$core$Json_Decode$decodeString, _alltonp$reprobate$ConfigEditor_Codec$agentModelDecoder, serialised);
};

var _alltonp$reprobate$ConfigEditor_Msg$NoOp = {ctor: 'NoOp'};
var _alltonp$reprobate$ConfigEditor_Msg$CancelCommand = {ctor: 'CancelCommand'};
var _alltonp$reprobate$ConfigEditor_Msg$RunCommand = {ctor: 'RunCommand'};
var _alltonp$reprobate$ConfigEditor_Msg$CommandChanged = function (a) {
	return {ctor: 'CommandChanged', _0: a};
};
var _alltonp$reprobate$ConfigEditor_Msg$Load = function (a) {
	return {ctor: 'Load', _0: a};
};
var _alltonp$reprobate$ConfigEditor_Msg$Error = function (a) {
	return {ctor: 'Error', _0: a};
};

var _alltonp$reprobate$ConfigEditor_Messaging$portMessageToMsg = function (message) {
	var _p0 = message.typeName;
	if (_p0 === 'LoadAgentModel') {
		var _p1 = _alltonp$reprobate$ConfigEditor_Codec$decodeAgentModel(message.payload);
		if (_p1.ctor === 'Ok') {
			return _alltonp$reprobate$ConfigEditor_Msg$Load(_p1._0);
		} else {
			return _alltonp$reprobate$ConfigEditor_Msg$Error(_p1._0);
		}
	} else {
		return _alltonp$reprobate$ConfigEditor_Msg$Error(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'Received unknown message: ',
				_elm_lang$core$Basics$toString(message)));
...
var _alltonp$reprobate$ConfigEditor_Port$configEditorAgentFromLift = _elm_lang$core$Native_Platform.incomingPort(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'typeName', _elm_lang$core$Json_Decode$string)));
var _alltonp$reprobate$ConfigEditor_Port$configEditorAgentToLift = _elm_lang$core$Native_Platform.outgoingPort(
	'configEditorAgentToLift',
	function (v) {
		return {typeName: v.typeName, payload: v.payload};
	});

var _alltonp$reprobate$ConfigEditor_Update$cancelCommand = function (command) {
	return A2(_alltonp$reprobate$Belch$PortMessage, 'CancelCommand', command);
};
var _alltonp$reprobate$ConfigEditor_Update$runCommand = function (command) {
	return A2(_alltonp$reprobate$Belch$PortMessage, 'RunCommand', command);
};
var _alltonp$reprobate$ConfigEditor_Update$update = F2(
	function (action, model) {
		var _p0 = action;
		switch (_p0.ctor) {
			case 'Error':
			...
			case 'RunCommand':
				...
				return {
					ctor: '_Tuple2',
					_0: model_,
					_1: _alltonp$reprobate$ConfigEditor_Port$configEditorAgentToLift(
						_alltonp$reprobate$ConfigEditor_Update$runCommand(model.command))
				};
			case 'CancelCommand':
				var model_ = _elm_lang$core$Native_Utils.update(
					model,
				...
				return {
					...
					_0: model_,
					_1: _alltonp$reprobate$ConfigEditor_Port$configEditorAgentToLift(
						_alltonp$reprobate$ConfigEditor_Update$cancelCommand(''))
				};
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
		...
		return A2(
			_elm_lang$html$Html$textarea,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onInput(
						function (v) {
							return _alltonp$reprobate$ConfigEditor_Msg$CommandChanged(v);
						}),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$disabled(disable),
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$rows(30),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _alltonp$reprobate$ConfigEditor_View_ops = _alltonp$reprobate$ConfigEditor_View_ops || {};
_alltonp$reprobate$ConfigEditor_View_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _alltonp$reprobate$ConfigEditor_View$saveButton = A2(
	_elm_lang$html$Html$button,
	{
		...
		_1: {
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_alltonp$reprobate$ConfigEditor_View_ops['=>'], 'padding', '0px'),
					_1: {
						ctor: '::',
						_0: A2(_alltonp$reprobate$ConfigEditor_View_ops['=>'], 'margin', '0px'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_alltonp$reprobate$ConfigEditor_Msg$RunCommand),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$title('Save'),
					_1: {ctor: '[]'}
				}
			}
		}
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('fa fa-check fa-2x'),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'}),
		_1: {ctor: '[]'}
...
var _alltonp$reprobate$ConfigEditor_View$cancelButton = A2(
	_elm_lang$html$Html$button,
	{
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_alltonp$reprobate$ConfigEditor_Msg$CancelCommand),
				_1: {
					ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('fa fa-times fa-2x'),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'}),
		_1: {ctor: '[]'}
...
var _alltonp$reprobate$ConfigEditor_View$agentView = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: A2(_alltonp$reprobate$ConfigEditor_View$configEditor, model.command, false),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					...
					{
						ctor: '::',
						_0: _alltonp$reprobate$ConfigEditor_View$saveButton,
						_1: {
							ctor: '::',
							_0: _alltonp$reprobate$ConfigEditor_View$cancelButton,
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: _alltonp$reprobate$ConfigEditor_View$agentView(model),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _alltonp$reprobate$ConfigEditorAgent$subscriptions = function (model) {
	return _alltonp$reprobate$ConfigEditor_Port$configEditorAgentFromLift(_alltonp$reprobate$ConfigEditor_Messaging$portMessageToMsg);
};
var _alltonp$reprobate$ConfigEditorAgent$view = function (model) {
	return _alltonp$reprobate$ConfigEditor_View$view(model);
};
var _alltonp$reprobate$ConfigEditorAgent$update = F2(
	function (action, model) {
		return A2(_alltonp$reprobate$ConfigEditor_Update$update, action, model);
	});
var _alltonp$reprobate$ConfigEditorAgent$main = _elm_lang$html$Html$program(
	{init: _alltonp$reprobate$ConfigEditor_Update$init, view: _alltonp$reprobate$ConfigEditorAgent$view, update: _alltonp$reprobate$ConfigEditorAgent$update, subscriptions: _alltonp$reprobate$ConfigEditorAgent$subscriptions})();

var Elm = {};
Elm['Belch'] = Elm['Belch'] || {};
if (typeof _alltonp$reprobate$Belch$main !== 'undefined') {
    _alltonp$reprobate$Belch$main(Elm['Belch'], 'Belch', undefined);
}
Elm['CommandEditor'] = Elm['CommandEditor'] || {};
Elm['CommandEditor']['Codec'] = Elm['CommandEditor']['Codec'] || {};
if (typeof _alltonp$reprobate$CommandEditor_Codec$main !== 'undefined') {
    _alltonp$reprobate$CommandEditor_Codec$main(Elm['CommandEditor']['Codec'], 'CommandEditor.Codec', undefined);
}
Elm['CommandEditor'] = Elm['CommandEditor'] || {};
Elm['CommandEditor']['Messaging'] = Elm['CommandEditor']['Messaging'] || {};
if (typeof _alltonp$reprobate$CommandEditor_Messaging$main !== 'undefined') {
    _alltonp$reprobate$CommandEditor_Messaging$main(Elm['CommandEditor']['Messaging'], 'CommandEditor.Messaging', undefined);
}
Elm['CommandEditor'] = Elm['CommandEditor'] || {};
Elm['CommandEditor']['Model'] = Elm['CommandEditor']['Model'] || {};
if (typeof _alltonp$reprobate$CommandEditor_Model$main !== 'undefined') {
    _alltonp$reprobate$CommandEditor_Model$main(Elm['CommandEditor']['Model'], 'CommandEditor.Model', undefined);
}
Elm['CommandEditor'] = Elm['CommandEditor'] || {};
Elm['CommandEditor']['Msg'] = Elm['CommandEditor']['Msg'] || {};
if (typeof _alltonp$reprobate$CommandEditor_Msg$main !== 'undefined') {
    _alltonp$reprobate$CommandEditor_Msg$main(Elm['CommandEditor']['Msg'], 'CommandEditor.Msg', undefined);
}
Elm['CommandEditor'] = Elm['CommandEditor'] || {};
Elm['CommandEditor']['Port'] = Elm['CommandEditor']['Port'] || {};
if (typeof _alltonp$reprobate$CommandEditor_Port$main !== 'undefined') {
    _alltonp$reprobate$CommandEditor_Port$main(Elm['CommandEditor']['Port'], 'CommandEditor.Port', undefined);
}
Elm['CommandEditor'] = Elm['CommandEditor'] || {};
Elm['CommandEditor']['Update'] = Elm['CommandEditor']['Update'] || {};
if (typeof _alltonp$reprobate$CommandEditor_Update$main !== 'undefined') {
    _alltonp$reprobate$CommandEditor_Update$main(Elm['CommandEditor']['Update'], 'CommandEditor.Update', undefined);
}
Elm['CommandEditor'] = Elm['CommandEditor'] || {};
Elm['CommandEditor']['View'] = Elm['CommandEditor']['View'] || {};
if (typeof _alltonp$reprobate$CommandEditor_View$main !== 'undefined') {
    _alltonp$reprobate$CommandEditor_View$main(Elm['CommandEditor']['View'], 'CommandEditor.View', undefined);
}
Elm['CommandEditorAgent'] = Elm['CommandEditorAgent'] || {};
if (typeof _alltonp$reprobate$CommandEditorAgent$main !== 'undefined') {
    _alltonp$reprobate$CommandEditorAgent$main(Elm['CommandEditorAgent'], 'CommandEditorAgent', undefined);
}
Elm['ConfigEditor'] = Elm['ConfigEditor'] || {};
Elm['ConfigEditor']['Codec'] = Elm['ConfigEditor']['Codec'] || {};
if (typeof _alltonp$reprobate$ConfigEditor_Codec$main !== 'undefined') {
    _alltonp$reprobate$ConfigEditor_Codec$main(Elm['ConfigEditor']['Codec'], 'ConfigEditor.Codec', undefined);
}
Elm['ConfigEditor'] = Elm['ConfigEditor'] || {};
Elm['ConfigEditor']['Messaging'] = Elm['ConfigEditor']['Messaging'] || {};
if (typeof _alltonp$reprobate$ConfigEditor_Messaging$main !== 'undefined') {
    _alltonp$reprobate$ConfigEditor_Messaging$main(Elm['ConfigEditor']['Messaging'], 'ConfigEditor.Messaging', undefined);
}
Elm['ConfigEditor'] = Elm['ConfigEditor'] || {};
Elm['ConfigEditor']['Model'] = Elm['ConfigEditor']['Model'] || {};
if (typeof _alltonp$reprobate$ConfigEditor_Model$main !== 'undefined') {
    _alltonp$reprobate$ConfigEditor_Model$main(Elm['ConfigEditor']['Model'], 'ConfigEditor.Model', undefined);
}
Elm['ConfigEditor'] = Elm['ConfigEditor'] || {};
Elm['ConfigEditor']['Msg'] = Elm['ConfigEditor']['Msg'] || {};
if (typeof _alltonp$reprobate$ConfigEditor_Msg$main !== 'undefined') {
    _alltonp$reprobate$ConfigEditor_Msg$main(Elm['ConfigEditor']['Msg'], 'ConfigEditor.Msg', undefined);
}
Elm['ConfigEditor'] = Elm['ConfigEditor'] || {};
Elm['ConfigEditor']['Port'] = Elm['ConfigEditor']['Port'] || {};
if (typeof _alltonp$reprobate$ConfigEditor_Port$main !== 'undefined') {
    _alltonp$reprobate$ConfigEditor_Port$main(Elm['ConfigEditor']['Port'], 'ConfigEditor.Port', undefined);
}
Elm['ConfigEditor'] = Elm['ConfigEditor'] || {};
Elm['ConfigEditor']['Update'] = Elm['ConfigEditor']['Update'] || {};
if (typeof _alltonp$reprobate$ConfigEditor_Update$main !== 'undefined') {
    _alltonp$reprobate$ConfigEditor_Update$main(Elm['ConfigEditor']['Update'], 'ConfigEditor.Update', undefined);
}
Elm['ConfigEditor'] = Elm['ConfigEditor'] || {};
Elm['ConfigEditor']['View'] = Elm['ConfigEditor']['View'] || {};
if (typeof _alltonp$reprobate$ConfigEditor_View$main !== 'undefined') {
    _alltonp$reprobate$ConfigEditor_View$main(Elm['ConfigEditor']['View'], 'ConfigEditor.View', undefined);
}
Elm['ConfigEditorAgent'] = Elm['ConfigEditorAgent'] || {};
if (typeof _alltonp$reprobate$ConfigEditorAgent$main !== 'undefined') {
    _alltonp$reprobate$ConfigEditorAgent$main(Elm['ConfigEditorAgent'], 'ConfigEditorAgent', undefined);
}
