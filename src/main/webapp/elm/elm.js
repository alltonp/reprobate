...
var _alltonp$reprobate$ConfigEditor_View$agentView = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_alltonp$reprobate$ConfigEditor_View$configEditor, model.command, false),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_alltonp$reprobate$ConfigEditor_View$agentView(model)
					]))
			]));
};
...
var _alltonp$reprobate$ConfigEditorAgent$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _alltonp$reprobate$ConfigEditor_Update$init, update: _alltonp$reprobate$ConfigEditorAgent$update, view: _alltonp$reprobate$ConfigEditorAgent$view, subscriptions: _alltonp$reprobate$ConfigEditorAgent$subscriptions})
};
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['ConfigEditor']['Messaging'], 'ConfigEditor.Messaging', typeof _alltonp$reprobate$ConfigEditor_Messaging$main === 'undefined' ? null : _alltonp$reprobate$ConfigEditor_Messaging$main);
Elm['ConfigEditor'] = Elm['ConfigEditor'] || {};
Elm['ConfigEditor']['Model'] = Elm['ConfigEditor']['Model'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['ConfigEditor']['Model'], 'ConfigEditor.Model', typeof _alltonp$reprobate$ConfigEditor_Model$main === 'undefined' ? null : _alltonp$reprobate$ConfigEditor_Model$main);
Elm['ConfigEditor'] = Elm['ConfigEditor'] || {};
Elm['ConfigEditor']['Msg'] = Elm['ConfigEditor']['Msg'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['ConfigEditor']['Msg'], 'ConfigEditor.Msg', typeof _alltonp$reprobate$ConfigEditor_Msg$main === 'undefined' ? null : _alltonp$reprobate$ConfigEditor_Msg$main);
Elm['ConfigEditor'] = Elm['ConfigEditor'] || {};
Elm['ConfigEditor']['Port'] = Elm['ConfigEditor']['Port'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['ConfigEditor']['Port'], 'ConfigEditor.Port', typeof _alltonp$reprobate$ConfigEditor_Port$main === 'undefined' ? null : _alltonp$reprobate$ConfigEditor_Port$main);
Elm['ConfigEditor'] = Elm['ConfigEditor'] || {};
Elm['ConfigEditor']['Update'] = Elm['ConfigEditor']['Update'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['ConfigEditor']['Update'], 'ConfigEditor.Update', typeof _alltonp$reprobate$ConfigEditor_Update$main === 'undefined' ? null : _alltonp$reprobate$ConfigEditor_Update$main);
Elm['ConfigEditor'] = Elm['ConfigEditor'] || {};
Elm['ConfigEditor']['View'] = Elm['ConfigEditor']['View'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['ConfigEditor']['View'], 'ConfigEditor.View', typeof _alltonp$reprobate$ConfigEditor_View$main === 'undefined' ? null : _alltonp$reprobate$ConfigEditor_View$main);
Elm['ConfigEditorAgent'] = Elm['ConfigEditorAgent'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['ConfigEditorAgent'], 'ConfigEditorAgent', typeof _alltonp$reprobate$ConfigEditorAgent$main === 'undefined' ? null : _alltonp$reprobate$ConfigEditorAgent$main);
